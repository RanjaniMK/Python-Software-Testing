...
print(f"The area of {my_circle.name} is {my_circle.area()}")
print(f"The area of {my_rectangle.name} is {my_rectangle.area()}")
print(f"The area of {my_triangle.name} is {my_triangle.area()}")
